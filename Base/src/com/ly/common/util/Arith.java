...
public class Arith {
    ...
    */
	...
	{
		System.out.println(yuanToLi("5000000"));
		//System.out.println(com.asiainfo.frame.util.Arith.add(Double.parseDouble(yuanToLi("5000000")),0));
		System.out.println(Float.parseFloat("5000000"));
		System.out.println(fenToYuan("500"));
	}
}
