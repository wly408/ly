...
import com.ly.common.util.json.IgnoreFieldPropertyFilterImpl;
import com.ly.common.util.json.MyDateJsonValueProcessor;
import com.ly.common.util.json.MyObjectJsonValueProcessor;
import com.ly.common.util.json.NotIgnoreFieldPropertyFilterImpl;
...
//        jsonConfig.registerJsonValueProcessor(Timestamp.class,new MyDateJsonValueProcessor());
        jsonConfig.registerJsonValueProcessor(Object.class,new MyObjectJsonValueProcessor());
